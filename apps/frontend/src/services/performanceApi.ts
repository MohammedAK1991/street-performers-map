...
export class PerformanceApiService {
   ...
   */
  static async getNearbyPerformances(params: GetNearbyPerformancesParams): Promise<Performance[]> {
   ...
   */
  static async createPerformance(data: CreatePerformanceData): Promise<Performance> {
    return ApiClient.call<Performance>(
      api.post('/performances', data)
    );
  }
   ...
   */
  static async toggleLike(performanceId: string): Promise<{ liked: boolean; totalLikes: number }> {
   ...
   */
  static async updatePerformance(id: string, data: Partial<CreatePerformanceData>): Promise<Performance> {
    return ApiClient.call<Performance>(
      api.put(`/performances/${id}`, data)
    );
  }
  ...
  static async deletePerformance(id: string): Promise<void> {
    return ApiClient.call<void>(
      api.delete(`/performances/${id}`)
    );
  }
  ...
  static async startPerformance(id: string): Promise<Performance> {
    return ApiClient.call<Performance>(
      api.post(`/performances/${id}/start`)
    );
  }
