...
const createSamplePerformances = (userIds: string[]) => [
	{
		...
		description:
			"Beautiful jazz performance featuring classic standards and modern interpretations in the heart of Madrid. Join us for an evening of soulful music by the iconic Crystal Palace.",
		genre: "jazz",
		route: {
			stops: [
				{
					location: {
						coordinates: [-3.6821, 40.42],
	...
	},
	{
		...
		description:
			"Acoustic rock and folk covers with original compositions. Experience the energy of live street music in the bustling heart of Puerta del Sol.",
		genre: "rock",
		videoUrl:
			"https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
		videoThumbnail:
	...
	},
	{
		...
		title: "Folk Stories",
		description:
			"Traditional folk songs and storytelling from around the world. Each song carries the wisdom and beauty of different cultures and traditions.",
		genre: "folk",
		route: {
			stops: [
				{
	...
	},
	{
		...
		description:
			"An intimate classical guitar performance featuring works by Bach, Villa-Lobos, and contemporary composers. Perfect for a peaceful evening in Plaza de Oriente.",
		genre: "classical",
		route: {
			stops: [
				{
					location: {
						coordinates: [-3.7141, 40.418],
	...
	},
	{
		...
		description:
			"Smooth jazz for a late evening vibe. Join us for an intimate session featuring jazz standards and improvisational pieces.",
		genre: "jazz",
		route: {
			stops: [
				{
	...
	},
	{
		...
		description:
			"A community folk singing circle where stories and songs come together. Everyone is welcome to listen or participate in this magical sunset experience.",
		genre: "folk",
		route: {
			stops: [
				{
