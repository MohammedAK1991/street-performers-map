...
const nearbyPerformancesSchema = z.object({
	lat: z.string().transform((val) => Number.parseFloat(val)),
	lng: z.string().transform((val) => Number.parseFloat(val)),
	radius: z
		.string()
...
export class PerformanceController {
	...
	getMyPerformances = async (
		...
		try {
			...
			const performances =
				await this.performanceService.getPerformancesByPerformer(userId);
	...
	getNearbyPerformances = async (
		...
		try {
			...
			const performances = await this.performanceService.getNearbyPerformances(
				coordinates,
				radius,
				{
					genre,
	...
	deletePerformance = async (
		...
		try {
			...
			const deleted = await this.performanceService.deletePerformance(
				id,
				userId,
			);
	...
	toggleLikePerformance = async (
		...
		try {
			...
			const performance = await this.performanceService.toggleLikePerformance(
				id,
				userId,
			);
	...
	likePerformance = async (
		...
		try {
			...
			const performance = await this.performanceService.likePerformance(
				id,
				userId,
			);
	...
	startPerformance = async (
		...
		try {
			...
			const performance = await this.performanceService.startPerformance(
				id,
				userId,
			);
	...
	endPerformance = async (
		...
		try {
			...
			const performance = await this.performanceService.endPerformance(
				id,
				userId,
			);
