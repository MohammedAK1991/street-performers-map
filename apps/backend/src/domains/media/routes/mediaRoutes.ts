...
router.get('/videos/analytics', authenticate, videoController.getVideoAnalytics);
...
router.get('/performances/:performanceId/videos', videoController.getPerformanceVideos);
